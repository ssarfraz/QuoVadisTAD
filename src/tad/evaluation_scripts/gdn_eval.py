...
def eval_scores(scores, true_scores, th_steps, return_thresold=False): # TODO add docstring and / or make private
...
def get_err_median_and_iqr(predicted, groundtruth): # TODO add docstring and / or make private
...
def get_best_performance_data(total_err_scores, gt_labels, topk=1):# TODO add docstring and / or make private
